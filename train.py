...
start_epoch = 32  # start from epoch 0 or last epoch
...
trainset = ListDataset(root='/home/deva/s165/RFBNet-master/data/VOCdevkit/VOC0712/JPEGImages',
                       list_file='data/voc12_train.txt', train=True, transform=transform, input_size=512)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=8, shuffle=True, num_workers=4, collate_fn=trainset.collate_fn)

testset = ListDataset(root='/home/deva/s165/RFBNet-master/data/VOCdevkit/VOC2008/JPEGImages',
